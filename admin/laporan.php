...
<body class="font-roboto">
  ...
  <main class="pt-[100px] px-[20px] xl:ps-[350px] xl:pt-[50px]">
    ...
    <div class="no-scrollbar flex snap-x snap-proximity gap-[20px] overflow-auto xl:snap-none xl:flex-wrap xl:overflow-hidden">
      <div class="min-w-[500px] snap-center scroll-ml-6 lg:snap-none rounded-lg bg-black px-[30px] py-[45px] text-white">
        <p class="text-[3rem] font-semibold">100</p>
        <p class="text-[1.5rem] font-medium text-zinc-500">Buku</p>
      </div>
      <div class="min-w-[500px] snap-center scroll-ml-6 lg:snap-none rounded-lg bg-black px-[30px] py-[45px] text-white">
        <p class="text-[3rem] font-semibold">360</p>
        <p class="text-[1.5rem] font-medium text-zinc-500">Pengguna</p>
      </div>
      <div class="min-w-[500px] snap-center scroll-ml-6 lg:snap-none rounded-lg bg-black px-[30px] py-[45px] text-white">
        <p class="text-[3rem] font-semibold">50</p>
        <p class="text-[1.5rem] font-medium text-zinc-500">Petugas</p>
      </div>
    </div>
    <button class="mt-[50px] rounded-md px-[24px] py-[10px] text-center text-[1.25rem] font-medium bg-neutral-950 text-white hover:bg-neutral-900">Generate Laporan</button>
    <h2 class="mt-[35px] text-[1.5rem] font-semibold leading-none">
      Statistik Buku
    </h2>
    <h3 class="mb-[30px] mt-2 text-[1.15rem] leading-none">
      Top paling banyak disimpan
    </h3>
    <div class="flex flex-wrap gap-[20px]">
      <div class="w-[300px] rounded-lg border border-slate-200 shadow-lg shadow-slate-200">
        <img src="../assets/cover.jpg" alt="cover" class="w-full h-[226px] object-contain">
        <div class="p-[20px]">
          <div>
            <div class="mb-[10px] flex items-center gap-1">
              <i data-feather="heart"></i>
              <p class="text-[1.15rem] font-medium">1.502</p>
            </div>
            <p class="text-[1.5rem] font-medium">Filosofi Teras</p>
            <p class="text-[1.15rem] text-zinc-500">Henry Manampiring</p>
          </div>
        </div>
      </div>
      <div class="w-[300px] rounded-lg border border-slate-200 shadow-lg shadow-slate-200">
