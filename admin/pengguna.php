...
<body class="font-roboto">
  <div id="modal" class="hidden absolute h-screen w-full bg-black bg-opacity-25 flex justify-center items-center z-50">
    <form action="" class="bg-white rounded-lg px-[20px] py-[20px]">
      ...
      <p class="text-[3rem] font-bold">Ban Pengguna?</p>
      <p class="mb-[35px] text-[1.15rem] font-bold leading-none text-zinc-500">
        Ban radit.rchmd
      </p>
      ...
      <button class="mt-[20px] rounded-md px-[24px] py-[10px] text-center text-[1.25rem] font-medium bg-neutral-950 text-white w-full hover:bg-neutral-900">Ban</button>
    </form>
  </div>
  <header>
    <!-- small sidebar -->
  ...
  <main class="pt-[100px] px-[20px] xl:ps-[350px] xl:pt-[50px]">
    ...
    <div class="flex gap-[8px]">
      ...
      <div class="flex items-center justify-center rounded-lg bg-black px-[15px]">
        <a href=""><i data-feather="slash" class="text-white"></i></a>
      </div>
    </div>
        ...
        <tr class="rounded-lg border border-slate-200 bg-white shadow-lg shadow-slate-200">
          ...
          <td class="px-[10px]">
            <div class="flex gap-[8px]">
              ...
              <i data-feather="slash" onclick="handleModal()"></i>
            </div>
          </td>
        </tr>
      </tbody>
